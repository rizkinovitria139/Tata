<div class="container">
    <div class="card">
        <div class="card-header">Edit Lapor</div>
        <div class="card-body">
            <?php 
            ...
            <form method="post" action="<?php echo base_url(); ?>siswa/update">
                <input type="hidden" name="nis" id="nis" value="<?php echo $siswa->nis; ?>" />
                ...
                <div class="form-group">
                    ...
                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
                        ...
                        <option value="wanita" <?php echo ($siswa->jenis_kelamin ? 'wanita' : 'selected' ); ?>>Wanita
                        </option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control datepicker" readonly id="tanggal_lahir" name="tanggal_lahir"
                        value="<?php echo $siswa->tanggal_lahir; ?>">
                </div>

                <div class="form-group">
                    <label for="no_telp">No Telp</label>
                    <input type="number" class="form-control" value="<?php echo $siswa->no_telp; ?>" id="no_telp"
                        name="no_telp">
                </div>
