                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <?php foreach ($datajadwal as $key => $value) { ?>
                                <a class="dropdown-item" href="<?= base_url("Tambah_presensi/jadwal/") . $value['id'] ?>"><?= $value['nama_kelas'] . " (" . $value['hari'] . " " . $value['waktu_mulai'] . ")" ?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
        ...
        <?php foreach ($datapresensi as $d) : ?>
            <div class="modal fade" id="editPresensiModal<?= $d['id_presensi'] ?>" tabindex="-1" class="dialog" aria-labelledby="editPresensiModal<?= $d['id_presensi']; ?>Label" aria-hidden="true">
