                    ...
                    <tr>
                        ...
                        <th>
                            <div class="form-group m-0">
                                <select class="form-control" id="keterangan<?=$key?>">
                        ...
                        <th>
                            <input type="text" class="form-control" name="keterangan" id="ketsiswa<?= $key?>" aria-describedby="helpId" placeholder="Keterangan">
                        </th>
                    </tr>
                <?php } ?>
            </tbody>
