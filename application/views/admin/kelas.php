		                ...
		                <tbody>
		                    ...
		                    <tr>
		                        ...
		                        <td>
		                            ...
		                            <a class="btn btn-danger" href="<?= base_url('admin/delete_kelas/') . $k['id_kelas']; ?>"
		                                onclick="return confirm('Are you sure to delete this data ?');">
		                                <i class="far fa-trash-alt"></i>
		                            </a>
		                            <button class="btn btn-success btn-icon" type="button" id="tombol"
		                                onclick="Swal('Hello World','Latihan Sweetalert','success')"></button>
		                        </td>
		                    </tr>
		                    <?php $i++; ?>
		                    <?php endforeach; ?>
		...
		<!-- Edit Modal -->
		<?php foreach ($kelas as $k) : ?>
		<div class="modal fade" id="editkelasModal<?= $k['id_kelas'] ?>" tabindex="-1" kelas="dialog"
		    aria-labelledby="editkelasModal<?= $k['id_kelas']; ?>Label" aria-hidden="true">
		        ...
		        <div class="modal-content">
		            ...
		            <form action="<?= base_url('admin/edit_kelas/' . $k['id_kelas']); ?>" method="post">
		                <div class="modal-body">
		                    <div class="form-group">
		                        <span>Id Kelas</span>
		                        <input type="text" class="form-control" readonly value="<?= $k['id_kelas']; ?>" id="id_kelas"
		                            name="id_kelas" placeholder="Id Kelas">
		                    </div>
		                    <div class="form-group">
		                        <span>Nama Kelas</span>
