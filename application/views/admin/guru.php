		...
		<div class="container-fluid">
			...
			<a class="btn btn-warning mb-3" data-toggle="modal" data-target="#tambahGuruModal">Tambah Siswa</a>
			<div class="col-lg">
					...
					<form action="<?php echo base_url(); ?>admin/tambah_guru" method="post">
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" placeholder="Masukkan Nama Guru">
							</div>

							<div class="form-group">
								<span>Tanggal Lahir</span>
								<input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" placeholder="Masukkan Nama Guru">
							</div>
							...
							<div class="form-group">
								<span>Alamat</span>
								<input type="text" class="form-control" id="alamat" name="alamat" placeholder="Masukkan Nama Guru">
							</div>
							<div class="form-group">
								<span>Nomor Telepon</span>
								<input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Masukkan Nama Guru">
							</div>
							<div class="form-group">
								<span>Tanggal Masuk</span>
								<input type="date" class="form-control" id="tanggal_masuk" name="tanggal_masuk" placeholder="Masukkan Nama Guru">
							</div>
							<div class="form-group">
								<span>Email</span>
								<input type="text" class="form-control" id="email" name="email" placeholder="Masukkan Nama Guru">
							</div>
							...
							<div class="form-group">
								<span>Is Active</span>
								<input type="text" class="form-control" id="is_active" name="is_active" placeholder="Masukkan Nama Guru">
							</div>
							...
							<div class="form-group">
								<span>Username</span>
								<input type="text" class="form-control" id="username" name="username" placeholder="Masukkan Nama Guru">
							</div>
							<div class="form-group">
								<span>Password</span>
