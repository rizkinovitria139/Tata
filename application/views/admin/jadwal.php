		                ...
		                <tbody>
		                    ...
		                    <tr>
		                        ...
		                        <td>
		                            ...
		                            <a class="btn btn-danger" href="<?= base_url('admin/delete_jadwal/') . $j['id']; ?>"
		...
		<?php foreach ($jadwal as $j) : ?>
		<div class="modal fade" id="editjadwalModal<?= $j['id'] ?>" tabindex="-1" kelas="dialog"
		    aria-labelledby="editjadwalModal<?= $j['id']; ?>Label" aria-hidden="true">
		        ...
		        <div class="modal-content">
		            ...
		            <form action="<?= base_url('admin/edit_jadwal/' . $j['id']); ?>" method="post">
		                <div class="modal-body">
		                    <div class="form-group">
		                        <span>ID Jadwal</span>
		                        <input type="text" class="form-control" readonly value="<?= $j['id']; ?>" id="id" name="id"
		                    ...
		                    <div class="form-group">
		                        <span>Waktu</span>
		                        <select name="waktu" id="waktu" class="form-control">
		                            <option value="<?= $j['waktu']; ?>" selected><?= $j['waktu']; ?></option>
		                            <option value="07.00 - 07.30">07.00 - 07.30</option>
		                            <option value="07.30 - 08.00">07.30 - 08.00</option>
		                            <option value="08.30 - 09.00">08.30 - 09.00</option>
		                            <option value="09.00 - 09.30">09.00 - 09.30</option>
		                    ...
		                    <div class="form-group">
		                        <span>Jam Ke</span>
		                        <select name="jam_ke" id="jam_ke" class="form-control">
		                            <option value="<?= $j['jam_ke']; ?>" selected><?= $j['jam_ke']; ?></option>
		                            <option value="1">1</option>
		                            <option value="2">2</option>
		                            <option value="3">3</option>
		                            <option value="4">4</option>
