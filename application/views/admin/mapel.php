		                ...
		                <tr>
		                    ...
		                    <td>
		                        <a class="btn btn-primary btn-icon" href="" data-toggle="modal"
		                            data-target="#editmapelModal<?= $m['id_mapel']; ?>">
		                            <i class="far fa-edit"></i>
		                        </a>
		                        <a class="btn btn-danger" href="<?= base_url('admin/delete_mapel/') . $m['id_mapel']; ?>"
		        ...
		        <div class="modal-content">
		            ...
		            <form action="<?php echo base_url(); ?>admin/tambah_mapel" method="post">
		                <div class="modal-body">
		                    ...
		                    <span>Nilai KKM</span>
		                    <div class="form-group">
		                        <input type="text" class="form-control" id="nilai_kkm" name="nilai_kkm"
		...
		<?php foreach ($mapel as $m) : ?>
		<div class="modal fade" id="editmapelModal<?= $m['id_mapel'] ?>" tabindex="-1" kelas="dialog"
		    aria-labelledby="editmapelModal<?= $m['id_mapel']; ?>Label" aria-hidden="true">
		        ...
		        <div class="modal-content">
		            ...
		            <form action="<?= base_url('admin/edit_mapel/' . $m['id_mapel']); ?>" method="post">
		                <div class="modal-body">
		                    <div class="form-group">
		                        <span>ID Mapel</span>
		                        <input type="text" class="form-control" readonly value="<?= $m['id_mapel']; ?>" id="id_mapel"
		                            name="id_mapel" placeholder="Id mapel">
		                    </div>
		                    <div class="form-group">
		                        <span>Nama Mapel</span>
		                        <input type="text" class="form-control" value="<?= $m['nama_mapel']; ?>" id="nama_mapel"
		                            name="nama_mapel" placeholder="Nama Mapel">
		                    </div>
		                    <div class="form-group">
		                        <span>Nilai KKM</span>
		                        <input type="text" class="form-control" value="<?= $m['nilai_kkm']; ?>" id="nilai_kkm"
		                            name="nilai_kkm" placeholder="Nilai KKM">
		                    </div>
